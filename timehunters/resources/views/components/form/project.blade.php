<div class="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
    ...
    <div class="mx-auto max-w-2xl text-center">
      <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Create Project</h2>
      <p class="mt-2 text-lg leading-8 text-gray-600">Create new project</p>
      @if ($errors->any())
    ...
    <form action="/projects" method="POST" class="mx-auto mt-16 max-w-xl sm:mt-20">
      @csrf
      <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
        ...
        <div class="sm:col-span-2">
          <label for="deadline" class="block text-sm font-semibold leading-6 text-gray-900">Deadline</label>
          <div class="mt-2.5 relative" data-te-datepicker-init data-te-input-wrapper-init data-te-disable-past="true">
            <input type="deadline" value="" name="deadline" id="deadline" placeholder="31-12-20XX" autocomplete="deadline" class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
          </div>
        </div>
      </div>
      <div class="mt-10">
